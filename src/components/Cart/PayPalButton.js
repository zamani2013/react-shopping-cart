...
export default class MyApp extends React.Component {
    render() {
        ...
        let currency = 'USD'; // or you can set this value from your props or stat // same as above, this is the total amount (based on currency) to be paid by using Paypal express checkout
